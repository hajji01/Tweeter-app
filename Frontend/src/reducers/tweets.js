...
export const tweetsSlice = createSlice({
    ...
    reducers: {
        loadTweets: (state, action) => {
            state.value = action.payload; // Charger des tweets
        },
        addTweet: (state, action) => {
            state.value.unshift(action.payload); // Ajouter un tweet
        },
        ...
        deleteTweet: (state, action) => {
            state.value = state.value.filter(tweet => tweet._id !== action.payload); // Supprimer un tweet
        },
    },
});
